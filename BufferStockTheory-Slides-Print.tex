\input{./econtexRoot}\input{\econtexRoot/econtexPaths}\documentclass[pdflatex]{beamer}\providecommand{\texname}{BufferStockTheorySlides}% Indicate the keyname for the bibtex entry corresponding to this document
